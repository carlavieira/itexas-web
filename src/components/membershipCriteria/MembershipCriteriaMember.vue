<template>
  <v-container>
    ...
    >
      ...
      <template
        v-slot:item.officeHoursCriteria="{ item }"
      >{{ formatPercentage(item.officeHoursCriteria) }}</template>
      <template
        v-slot:item.meetingsCriteria="{ item }"
      >{{ formatPercentage(item.meetingsCriteria) }}</template>
      <template v-slot:item.eventsCriteria="{ item }">{{ formatPercentage(item.eventsCriteria) }}</template>
